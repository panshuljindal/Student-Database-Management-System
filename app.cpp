...
#include<graphics.h>//for delay() ,initgraph() , readimagefile() , closegraph()
...
int main()
{
   ...
   cout<<"Name:                                     PANSHUL JINDAL                      KHUSHEE JAIN                   GAURAV GOVERDHAN       \n";
   cout<<"Registeration Number:                      19BCE2227                           19BCE0914                        19BCB0098              \n";
   int gd=DETECT,gm;;
   initgraph(&gd,&gm,"C:\\TC\\BGI");
   readimagefile("sdms.jpg",50,100,600,400); //AND IMAGE TO IMPROVE THE VISUAL MOTIVE OF PROJECT
   getch();
   closegraph();
   int i=0;
   system("pause");
...
while(i<4)
{
    i++;
    cout<<". ";
    delay(1000); // to give the effect of application being loaded into the RAM
